...
{
       0,   122,   122,   130,   136,   143,   144,   147,   154,   163,
     169,   176,   176,   178,   178,   178,   180,   190,   207,   212,
     217,   223,   224,   227,   230,   233,   236,   239,   240,   241,
     242,   243,   244,   247,   253,   253,   255,   265,   277,   284,
     295,   303,   307,   311,   317,   321,   326,   328,   332,   335,
     338,   339,   343,   347,   351,   355,   359,   363,   367,   373,
     377,   381,   385,   391,   393,   397,   401,   408,   412,   416,
     420,   421,   428,   433,   438,   444,   445,   450,   454,   458
};
#endif
...
dlinkApply((yyvsp[-3].idList), (DLinkApplyFunc)(((yyvsp[-1].regIndex) == 1) ? initializeArraySymbolEntry : addIdToSymtab));
...
initializeArrayDimensions(symIndex, atoi((yyvsp[0].name)), atoi((yyvsp[-2].name)));	
}
...
int symIndex = SymIndex(globalSymtab, (yyval.name));
initializeArrayDimensions(symIndex, -atoi((yyvsp[0].name)), -atoi((yyvsp[-3].name)));	
}
...
#line 1446 "PJParser.c"
    break;

  case 34: /* IfStatement: T_IF TestAndThen T_ELSE Statement  */
#line 253 "PJParser.y"
                                               { initializeLoopControl(instList, (yyvsp[-2].regIndex));}
#line 1452 "PJParser.c"
    break;

  case 35: /* IfStatement: T_IF TestAndThen  */
#line 253 "PJParser.y"
                                                                                                         { initializeLoopControl(instList, (yyvsp[0].regIndex));}
...
initializeComparisonTest(instList, leftOperand, (yyvsp[0].regIndex));
...
initializeJumpOperation(instList, (yyvsp[-3].regIndex), "jmp");
...
(yyval.regIndex) = generateArrayOffsetAddress(instList, symIndex, (yyvsp[-1].regIndex));
}
...
(yyval.regIndex) = generate2DArrayOffsetAddress(instList, symIndex, (yyvsp[-3].regIndex), (yyvsp[-1].regIndex));	
}
#line 1755 "PJParser.c"
    break;
...
#line 1788 "PJParser.c"
    break;


#line 1792 "PJParser.c"
